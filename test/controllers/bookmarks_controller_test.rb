...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { link: @bookmark.link, mark_type_id: @bookmark.mark_type_id, name: @bookmark.name } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { link: @bookmark.link, mark_type_id: @bookmark.mark_type_id, name: @bookmark.name } }
